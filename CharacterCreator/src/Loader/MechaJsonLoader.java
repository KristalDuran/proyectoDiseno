 ...
 * @author Pumkin
 */
public class MechaJsonLoader implements ICharacterLoader{

    private List<IWeapon> weapons = new ArrayList<>(); 
    
    public MechaJsonLoader(List<IWeapon> weapons) {
        ...
        try {
            ...
            for (Object o : a){
                ...
                Mecha c = new Mecha(
                        ...
                        (float)((Long)mecha.get("hp")),
                        ((Double)mecha.get("dps")).floatValue(), 
