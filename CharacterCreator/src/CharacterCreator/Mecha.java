 ...
 * @author Pumkin
 */
public class Mecha extends ICharacter implements IPrototypeCharacter{
    ...
    public Mecha(String name, int level, double hp, double dps, int cost, 
    ...
    public IPrototypeCharacter clone() {
        return new Mecha(this.name,this.level, this.hp, this.dps, this.cost,
        this.size, this.playerLevel, this.imgPaths);
    }
